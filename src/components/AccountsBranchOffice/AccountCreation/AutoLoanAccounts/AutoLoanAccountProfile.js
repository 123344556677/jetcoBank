...
import AutoLoanAccountProfileForm from "./AutoLoanAccountProfileForm";
import { autoLoanAccountData } from "mock-data/ProfileFormData";

const AutoLoanAccountProfile = () => {
      ...
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Account Detail" && (
          <>
            ...
            />
            <ProfileForms
              formData={autoLoanAccountData}
              component="Auto Loans Account"
            />
          </>
        )}
        {activeProfileBarComponent === "Personal Detail" && (
          <AutoLoanAccountProfileForm />
        )}
      </div>
    </div>
  );
...
export default AutoLoanAccountProfile;
