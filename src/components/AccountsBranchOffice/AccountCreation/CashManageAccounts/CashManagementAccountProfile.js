...
import { cashManagementAccountPersonalData } from "mock-data/ProfileFormData";
import { cashManagementAccountData } from "mock-data/ProfileFormData";
import React, { useState } from "react";

const CashManagementAccountProfile = () => {
      ...
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Account Detail" && (
          <>
            <CustomHeaderCards
              cardValues={cardData}
              component="Cash Management Account"
            />
            <ProfileForms
              formData={cashManagementAccountData}
              component="Cash Management Account"
            />
          </>
        )}
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms
            formData={cashManagementAccountPersonalData}
            component="Cash Management Account"
          />
        )}
      </div>
...
export default CashManagementAccountProfile;
