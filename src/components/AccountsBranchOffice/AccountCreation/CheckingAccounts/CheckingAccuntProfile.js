...
import { checkingAccountPersonalData } from "mock-data/ProfileFormData";
import { checkingAccountData } from "mock-data/ProfileFormData";
import React, { useState } from "react";

const CheckingAccuntProfile = () => {
      ...
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Account Detail" && (
          <>
            ...
            />
            <ProfileForms
              formData={checkingAccountData}
              component="Checking Account"
            />
          </>
        )}
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms formData={checkingAccountPersonalData} component="Checking Account" />
        )}
      </div>
    </div>
  );
...
export default CheckingAccuntProfile;
