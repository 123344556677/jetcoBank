...
import { corporateAccountPersonalData } from "mock-data/ProfileFormData";
import { corporateAccountData } from "mock-data/ProfileFormData";
import React, { useState } from "react";

const CorporateAccountProfile = () => {
      ...
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Account Detail" && (
          <>
            <CustomHeaderCards
              cardValues={cardData}
              component="Saving Account"
            />
            <ProfileForms
              formData={corporateAccountData}
              component="Saving Account"
            />
          </>
        )}
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms
            formData={corporateAccountPersonalData}
            component="Saving Account"
          />
        )}
      </div>
...
export default CorporateAccountProfile;
