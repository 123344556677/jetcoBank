...
import { creditCardAccountData } from 'mock-data/ProfileFormData';
import React, { useState } from 'react'

const CreditCardAccountProfile = () => {
      ...
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Account Detail" && (
          <>
            ...
            />
            <ProfileForms
              formData={creditCardAccountData}
              component="Credit Card Account"
            />
          </>
        )}
...
export default CreditCardAccountProfile