...
import { loanAccountPersonalData } from "mock-data/ProfileFormData";
import { loanAccountData } from "mock-data/ProfileFormData";
import React, { useState } from "react";

const LoanAccountProfile = () => {
    ...
    <div className="pt-5 pt-md-8 mb-3 ml-lg-3 mr-lg-3">
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Account Detail" && (
          <>
            <CustomHeaderCards cardValues={cardData} component="Loan Account" />
            <ProfileForms formData={loanAccountData} component="Loan Account" />
          </>
        )}
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms
            formData={loanAccountPersonalData}
...
export default LoanAccountProfile;
