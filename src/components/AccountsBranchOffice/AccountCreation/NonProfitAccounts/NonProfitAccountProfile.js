...
import { nonProfitAccountPersonalData } from "mock-data/ProfileFormData";
import { nonProfitAccountData } from "mock-data/ProfileFormData";
import React, { useState } from "react";

const NonProfitAccountProfile = () => {
    ...
    <div className="pt-5 pt-md-8 mb-3 ml-lg-3 mr-lg-3">
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms
            formData={nonProfitAccountPersonalData}
            component="Non Profit Account"
          />
        )}
      </div>
...
export default NonProfitAccountProfile;
