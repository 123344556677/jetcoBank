...
import { savingAccountPersonalData } from "mock-data/ProfileFormData";
import { savingAccountData } from "mock-data/ProfileFormData";
import React, { useState } from "react";

const SavingAccountProfile = () => {
    ...
    <div className="pt-5 pt-md-8 mb-3 ml-lg-3 mr-lg-3">
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms
            formData={savingAccountPersonalData}
            component="Saving Account"
          />
        )}
      </div>
...
export default SavingAccountProfile;
