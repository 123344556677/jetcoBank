...
import { soleProprietorAccountPersonalData } from "mock-data/ProfileFormData";
import { soleProprietorAccountData } from "mock-data/ProfileFormData";
import React, { useState } from "react";

const SoleProprietorAccountProfile = () => {
    ...
    <div className="pt-5 pt-md-8 mb-3 ml-lg-3 mr-lg-3">
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms
            formData={soleProprietorAccountPersonalData}
            component="Sole Proprietor Account"
          />
        )}
      </div>
...
export default SoleProprietorAccountProfile;
