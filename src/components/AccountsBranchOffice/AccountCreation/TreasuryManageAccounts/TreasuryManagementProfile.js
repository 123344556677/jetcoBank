...
import { treasuryManagementAccountPersonalData } from "mock-data/ProfileFormData";
import { treasuryManagementAccountData } from "mock-data/ProfileFormData";
import React, { useState } from "react";

const TreasuryManagementAccountProfile = () => {
      ...
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Account Detail" && (
          <>
            <CustomHeaderCards
              cardValues={cardData}
              component="Treasury Management Account"
            />
            <ProfileForms
              formData={treasuryManagementAccountData}
              component="Treasury Management Account"
            />
          </>
        )}
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms
            formData={treasuryManagementAccountPersonalData}
            component="Treasury Management Account"
          />
        )}
      </div>
...
export default TreasuryManagementAccountProfile;
