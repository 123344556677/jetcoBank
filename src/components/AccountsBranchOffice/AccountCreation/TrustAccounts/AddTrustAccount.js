  ...
  return (
    <div className="pt-5 pt-md-8 mb-3 ml-lg-3 mr-lg-3">
      <div className="main-div">
        <FormTopBar buttonValue="Create Trust Accounts" />
        <Form className="m-4">
          ...
          <Label className="form-label">Add Trust Detail</Label>
          <div className="main-div">
            <div className="m-2">
              <br />
              <h4 className="">Add Settlor Information:</h4>
              <br />
          ...
          <div className="main-div mt-4">
            <div className="m-2">
              <br />
              <h4 className="">Specify Trustee Detail:</h4>
              <br />
          ...
          <div className="main-div mt-4">
            <div className="m-2">
              <br />
              <h4 className="">Define Trusts Purpose and Objectives:</h4>
              <br />
