  ...
  return (
    ...
    <div className="main-div">
      ...
      <div className="d-flex justify-content-between align-items-center mr-lg-3">
        ...
        <DynamicTable headings={currencyExchangeListingHeadingsTable} tableData={currencyExchangeListingHeadingsTableData} component="CurrencyExchange" parentComponent="FinServicesAndMessaging" />
      </div>
    </div>
  )
}
