...
import { userData } from "mock-data/ProfileFormData";
import CustomHeaderCards from "components/CustomHeaderCards/CustomHeaderCards";
import { userAccountData } from "mock-data/ProfileFormData";
    ...
    <div className="pt-5 pt-md-8 mb-3 ml-lg-3 mr-lg-3">
      <div className="main-div ">
        ...
        {activeProfileBarComponent === "Account Detail" && (
          <>
            <CustomHeaderCards cardValues={cardData} component="User Account" />
            <ProfileForms formData={userAccountData} component="User Account" />
          </>
        )}
        {activeProfileBarComponent === "Personal Detail" && (
          <ProfileForms formData={userData} component="User" />
        )}
      </div>
    </div>
  );
