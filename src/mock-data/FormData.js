...
export const addMinistryForm = [
  ...
  },
  {
    ...
    type: "text",
    placeholder: "official services",
  },
];
export const addNotaryForm = [
  {
    label: "Name",
    name: "name",
    type: "text",
...
export const addRepresentativeForm = [
  {
    label: "Name",
    name: "name",
    type: "text",
  ...
  {
    label: "Tax Rpresentative Service",
    name: "taxRepresentativeService",
    type: "text",
    placeholder: "tax representative service",
  },
  {
    label: "Authorization",
    name: "authorization",
...
export const addGovtOfficalForm = [
  {
    label: "Name",
    name: "name",
    type: "text",
...
export const addFinancialInstForm = [
  {
  ...
  },
  {
    ...
    name: "instituition type",
    type: "text",
    placeholder: "instituition type",
  },
  {
    label: "Email",
    name: "email",
...
export const addContactForm = [
  {
    ...
    defaultValue:
      "Anyway, I'm pretty sure I'm just imagining things, but it made me think of you! How's everything going on your end? Let's catch up soon!",
  },
  {
    label: "Name",
    name: "name",
...
export const createTrustPurposeForm = [
  {
    ...
    placeholder: "purpose",
    defaultValue:
      "To provide educational support and financial assistance for the college tuition of John's grandchildren.",
  },
  {
    label: "Objectives",
    name: "objectives",
    type: "textarea",
    defaultValue:
      "Ensure funds are used exclusively for tuition and related educational expenses.Support academic pursuits and achievements",
...
export const createTrustDurationForm = [
  {
    ...
    defaultValue:
      "20 years from the date of establishment or until the youngest beneficiary completes their education, whichever comes later.",
  },
];
...
export const createMailSetupForm = [
  {
    label: "Name",
    name: "name",
    type: "text",
...
export const createMailCancelForm = [
  {
    label: "Mailbox I'D",
    name: "mailboxId",
    type: "text",
    placeholder: "mail box id",
  },
  {
...
export const createMailRenewalForm = [
  {
    label: "Mailbox I'D",
    name: "mailboxId",
    type: "text",
...
export const createAutoLoanForm = [
  {
    label: "Enter Borrower's Name",
    name: "borrowerName",
    type: "text",
...
export const createAutoLoanVehicleForm = [
  {
    label: "Make",
    name: "make",
    type: "text",
